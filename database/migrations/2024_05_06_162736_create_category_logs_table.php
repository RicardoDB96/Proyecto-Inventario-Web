...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('category_logs', function (Blueprint $table) {
            $table->increments('id')->comment('Id de del log de categoria');
            $table->integer('category_id')->unsigned(); // Agrega el campo para almacenar el ID de la categoría relacionada
